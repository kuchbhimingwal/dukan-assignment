    ...
    <div>
      <div className='flex justify-between'>
        ...
        <div className='flex justify-center items-center '>
          <div className='flex justify-center items-center p-1.5 px-3 border w-full rounded-md border-searchBar text-searchText font-light cursor-pointer'>Sort 
          ...
          <div className='flex justify-center items-center p-2 mx-2 border w-full rounded-md border-searchBar cursor-pointer opacity-70'>
