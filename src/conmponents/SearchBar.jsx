  ...
  return (
    <div>
      <div className='relative'>
        <input type="text" placeholder="Search features, tutorials, etc." class="py-2 px-4 pr-10 rounded-lg border border-gray-300 focus:outline-none focus:border-blue-500" />
        <svg class="absolute right-0 top-0 mt-2 mr-3 h-6 w-6 text-gray-400" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
