    ...
    <div className=''>
      <div className='bg-websiteBlue-light rounded shadow-sm p-4 mx-4 mt-4'>
        ...
        <div className='flex justify-between'>
          <div className='font-bold text-xl pt-2 text-white'>
            ₹{amount}
          </div>

          {orderCount ? <div className='flex text-white cursor-pointer font-medium text-xs pt-4'>
      ...
      {nextPayment ? 
      <div className='flex justify-between mx-4 bg-websiteBlue-dark text-white rounded-b'>
